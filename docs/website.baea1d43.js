...
}, "This website was not created by a website-builder, a template, or a copy-paste codebase.", /*#__PURE__*/React.createElement(Spacer, null), /*#__PURE__*/React.createElement(Spacer, null), "Everything was hand coded, from the angle of the shooting stars in the background to the color pallet of the cards. This site does not even a JavaScript framework like React, Vue, or Angular. The images in the background are all SVG's ready to be animated into action. Anime.js is the only major runtime library. Quik Stack (which uses Parcel.js and Express.js) was used for debugging/compiling the code."));
...
document.body = /*#__PURE__*/React.createElement("body", null, /*#__PURE__*/React.createElement("style", null, "\n        h3 {\n            font-size: 27pt;\n        }\n    "), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Silver Spectacle"), " that seemlessly takes advantage of the Web's powerful UI tools.", /*#__PURE__*/React.createElement(Spacer, null), "Here's part of the readme.md looks like:", /*#__PURE__*/React.createElement(Spacer, null), /*#__PURE__*/React.createElement("img", {
